...
import HybridBarcodeScanner from './components/HybridBarcodeScanner';
...
const PriceScannerApp = () => {
  ...
  // Handle barcode detection from HybridBarcodeScanner
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white min-h-screen">
      {/* HybridBarcodeScanner - Full screen overlay when active */}
      {showScanner && (
